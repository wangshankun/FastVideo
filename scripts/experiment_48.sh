...
torchrun --nnodes 2 --nproc_per_node 8\
    ...
    --cfg 0.0\
    --log_validation\
    --output_dir="$DATA_DIR/outputs/lq_euler_50_thres0.1_lrg_0.75_phase1_lr1e-6_pred_decay0.01_l2"\
    --tracker_project_name PCM \
    --num_frames  163 \
    --scheduler_type pcm_linear_quadratic \
    --validation_guidance_scale "0.5,1.5,2.5" \
...
torchrun --nnodes 2 --nproc_per_node 8\
    ...
    --cfg 0.0\
    --log_validation\
    --output_dir="$DATA_DIR/outputs/lq_euler_50_thres0.1_lrg_0.75_phase1_lr1e-6_pred_decay0.005_l2"\
    --tracker_project_name PCM \
    --num_frames  163 \
    --scheduler_type pcm_linear_quadratic \
    --validation_guidance_scale "0.5,1.5,2.5" \
